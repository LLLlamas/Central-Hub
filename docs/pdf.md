# PDF — viewer, highlighting plan, and in-house parser

> Combined from `pdf-highlighter.md` (viewer + unbuilt highlighting plan) and `PDF-Parser-In-House.md` (parser design notes) during the 2026-07-11 docs reorganization.
